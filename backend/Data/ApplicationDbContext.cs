        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(e => e.AssignedManufacturer)
                      ...
                      .OnDelete(DeleteBehavior.NoAction); // Changed for SQL Server compatibility
            ...
            builder.Entity<Campaign>(entity =>
            {
                ...
                // Use SQL Server compatible datetime
                entity.Property(e => e.CreatedAt)
                    .HasDefaultValueSql("GETDATE()")
                    .ValueGeneratedOnAdd();
            ...
            builder.Entity<Voucher>(entity =>
            {
                ...
                entity.Property(e => e.RedeemedAt).HasColumnType("datetime2");
            ...
            builder.Entity<CampaignPoints>(entity =>
            {
                ...
                entity.Property(e => e.UpdatedAt).HasColumnType("datetime2");
                entity.Property(e => e.LastVoucherGeneratedAt).HasColumnType("datetime2");
